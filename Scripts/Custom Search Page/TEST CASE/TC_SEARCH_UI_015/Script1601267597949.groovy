...
WebUI.setText(findTestObject('Search Objects/Page_diagnostics/input.Keywords-filter'), 'COVID19')

WebUI.click(findTestObject('Search Objects/Page_diagnostics/input_Molecular diagnostic_btn-find'))

WebUI.waitForElementVisible(findTestObject('Search Objects/Page_diagnostics/span_Result'), 0)

WebUI.verifyElementText(findTestObject('Search Objects/Page_diagnostics/span_Result'), 'COVID19')
